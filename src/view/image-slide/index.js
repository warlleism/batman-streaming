    ...
    return (
        <>
            <div className="batman-photo">
                <img className="img" id="photo1" src={Lies} onClick={photo1Transition} />
                <img className="img" id="photo2" src={Person} onClick={photo2Transition} />
                <img className="img" id="photo3" src={Car} onClick={photo3Transition} />
            </div>
        </>
    )
}
